...
public class PendingEntityPlaybackManager {
    ...
    public static void onEntityLoaded(UUID entityUuid, net.minecraft.entity.Entity ent) {
        ...
        CompletableFuture.runAsync(() -> {
            ...
            try {
                MusicPlayManager.playWithKey("entity:" + ent.getUuid().toString(), p.url().toString(), p.songName(), (url, start) -> new com.github.tartaricacid.netmusic.audio.NetMusicSound(ent, url, p.timeSecond(), recordRef.get(), start), p.playProgress());
            } catch (Throwable ex) {
