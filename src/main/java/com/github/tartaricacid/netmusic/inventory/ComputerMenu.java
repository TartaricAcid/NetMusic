...
public class ComputerMenu extends AbstractContainerMenu {
    public static final MenuType<@NotNull ComputerMenu> TYPE = new MenuType<>(ComputerMenu::new, FeatureFlags.VANILLA_SET);
    ...
    public void removed(Player player) {
        ...
        giveItemToPlayer(player, input.getItem());
        giveItemToPlayer(player, output.getItem());
    }
