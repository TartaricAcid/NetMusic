...
public class CDBurnerMenu extends AbstractContainerMenu {
    public static final MenuType<CDBurnerMenu> TYPE = new MenuType<>(CDBurnerMenu::new, FeatureFlags.VANILLA_SET);
    ...
    private final Slot output = new Slot(new SimpleContainer(1), 0, 147, 67) {
        @Override
    ...
    public CDBurnerMenu(int id, Inventory playerInventory, Inventory inventory) {
        super(TYPE, id);
    }
