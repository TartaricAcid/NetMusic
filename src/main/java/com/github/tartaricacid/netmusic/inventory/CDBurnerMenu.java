...
public class CDBurnerMenu extends Container {
    public static final ContainerType<CDBurnerMenu> TYPE = IForgeContainerType.create((windowId, inv, data) -> new CDBurnerMenu(windowId, inv));
    ...
    public CDBurnerMenu(int id, PlayerInventory inventory) {
        super(TYPE, id);
