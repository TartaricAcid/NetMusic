...
public class ClientReceiverRegistry {
    public static void register() {
        ...
        registerReceiver(BigMegaphoneStartMessage.TYPE, BigMegaphoneStartMessageReceiver::handle);
        registerReceiver(BigMegaphoneStopMessage.TYPE, BigMegaphoneStopMessageReceiver::handle);
