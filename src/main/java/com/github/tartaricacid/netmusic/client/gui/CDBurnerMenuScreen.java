...
public class CDBurnerMenuScreen extends AbstractContainerScreen<@NotNull CDBurnerMenu> {
    ...
    public boolean keyPressed(KeyEvent event) {
        // 防止 E 键关闭界面
        if (this.minecraft.options.keyInventory.matches(event) && textField.isFocused()) {
            return true;
        }
