...
public class ComputerMenuScreen extends AbstractContainerScreen<@NotNull ComputerMenu> {
    ...
    private void initUrlEditBox() {
        ...
        urlTextField = new EditBox(minecraft.font, leftPos + 10, topPos + 18,
    ...
    private void initNameEditBox() {
        ...
        nameTextField = new EditBox(minecraft.font, leftPos + 10, topPos + 39,
    ...
    private void initTimeEditBox() {
        ...
        timeTextField = new EditBox(minecraft.font, leftPos + 10, topPos + 61,
