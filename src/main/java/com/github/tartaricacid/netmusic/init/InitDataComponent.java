...
public class InitDataComponent {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<PlaylistData>> PLAYLIST_DATA = DATA_COMPONENTS
            .register("playlist_data", () -> DataComponentType.<PlaylistData>builder().persistent(PlaylistData.CODEC).networkSynchronized(PlaylistData.STREAM_CODEC).build());
}
