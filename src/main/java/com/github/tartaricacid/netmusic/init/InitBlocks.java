...
public class InitBlocks {
    ...
    public static Supplier<BlockEntityType<TileEntityMusicPlayer>> MUSIC_PLAYER_TE =
            TILE_ENTITIES.register("music_player", () -> new BlockEntityType<>(TileEntityMusicPlayer::new, MUSIC_PLAYER.get()));
    public static Supplier<BlockEntityType<TileEntityBigMegaphone>> BIG_MEGAPHONE_TE =
            TILE_ENTITIES.register("big_megaphone", () -> new BlockEntityType<>(TileEntityBigMegaphone::new, BIG_MEGAPHONE.get()));
}
